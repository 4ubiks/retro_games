bits 16
    ...
    org 0x7c00
    ; load into 0x8000, 128 sectors of 512 bytes, cylinder/head 0

    mov ax, 0
    mov es, ax

    mov ah, 0x02
    mov al, 0x80        ; al is number of sectors to write, 0x80 (128)
...
task_struct_kernel:
	...
	dd 0x39FFFF      ;; uint32_t esp0;     // The stack pointer to load when changing to kernel mode.
